...
// ---------- LOGIN & PIONEER TEST ----------
w.cPT=async function(){const p=ref(db,'users/LL77LL75');await set(p,{password:prompt("password"),rank:'pioneer',titles:['pioneer','founder'],equippedTitle:'pioneer',credits:9999,lastActive:now()});alert('Pioneer created');};
