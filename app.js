...
w.cPT=async function(){const p=ref(db,'users/'+a);await set(p,{password:prompt("password"),rank:'admin',titles:['pioneer','powerful'],equippedTitle:'pioneer',credits:150,lastActive:now()});alert('Pioneer created');};
